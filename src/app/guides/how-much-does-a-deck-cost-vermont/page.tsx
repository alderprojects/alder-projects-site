...
export const metadata: Metadata = {
  ...
  description: 'Vermont deck cost guide — pressure treated vs composite, permit requirements, and what drives price in Vermont specifically.',
...
const content = {
  ...
  sections: [
    ...
    { heading: 'Composite decking: $15,000 to $40,000', body: 'Composite decking costs more upfront but requires less maintenance and holds up better in Vermont winters. A mid-size composite deck with aluminum railing and stairs runs $18,000 to $28,000. Premium composites with hidden fasteners, built-in lighting, and multi-level layouts can reach $35,000 to $40,000.', list: ['Trex, TimberTech, Fiberon are the most common brands in Vermont', 'Aluminum or composite railing adds $80 to $150 per linear foot', 'Hidden fastener systems add $1,000 to $2,500 to most projects'] },
