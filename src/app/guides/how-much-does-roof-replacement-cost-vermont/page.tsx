...
export const metadata: Metadata = {
  ...
  description: 'Vermont roof replacement costs by material â asphalt shingles vs metal vs standing seam. Ice dam considerations and timing.',
