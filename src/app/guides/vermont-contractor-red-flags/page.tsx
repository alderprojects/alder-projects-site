...
export const metadata: Metadata = {
  ...
  description: "The warning signs that experienced Vermont homeowners watch for before hiring a contractor.",
...
const content = {
  ...
  },
  {
    ...
    "body": "We need a large deposit to order materials and we can start tomorrow. This is the most common setup for contractor fraud in Vermont. A reasonable deposit is 10 to 15 percent. Anything above 30 percent before work begins is a serious warning sign."
  }
],
  faqs: [
  {
    "q": "How do I verify a Vermont contractor is licensed?",
    "a": "Check contractor registration at labor.vermont.gov. Vermont requires registration for most residential construction work."
  },
  {
    "q": "What recourse do I have if a Vermont contractor does bad work?",
    "a": "Document everything in writing. Contact the Vermont Attorney General consumer protection division. Report unlicensed contractors to the Vermont Department of Labor."
  },
  {
    "q": "Is a verbal agreement binding in Vermont?",
    "a": "Verbal contracts can be legally binding in Vermont, but they are nearly impossible to enforce in practice. Always get the full scope, price, and timeline in writing before work begins."
  }
],
  ctaHeading: "Find vetted Vermont contractors for your project",
  ctaBody: "Post your project and we will match you with local contractors who have been reviewed before appearing on the platform.",
  relatedGuides: [
  {
