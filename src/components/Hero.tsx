      ...
      <div style={{position:'relative',zIndex:10,maxWidth:'1152px',margin:'0 auto',width:'100%',padding:'clamp(100px,12vw,140px) 24px clamp(60px,8vw,96px)',display:'grid',gridTemplateColumns:'repeat(auto-fit,minmax(300px,1fr))',gap:'48px',alignItems:'center'}}>
        <div>
          <div style={{display:'inline-flex',alignItems:'center',gap:'8px',padding:'5px 12px',border:'1px solid rgba(122,155,111,0.4)',borderRadius:'999px',marginBottom:'28px'}}>
            ...
            <span style={{fontSize:'11px',fontFamily:'monospace',letterSpacing:'0.12em',textTransform:'uppercase',color:'#7A9B6F'}}>Vermont-based contractors only</span>
          </div>
          <h1 ref={headRef} style={{fontFamily:"'Playfair Display',Georgia,serif",fontWeight:600,fontSize:'clamp(2.2rem,4.5vw,3.4rem)',lineHeight:1.08,letterSpacing:'-0.02em',color:'#F5EFE0',marginBottom:'20px'}}>
            The right Vermont<br/>
            contractor for your<br/>
            <em style={{color:'#C8732A',fontStyle:'normal'}}>renovation project.</em>
          </h1>
          <p style={{fontSize:'17px',fontWeight:300,lineHeight:1.75,color:'rgba(245,239,224,0.65)',maxWidth:'420px',marginBottom:'36px'}}>
            Describe your project. We review it and connect you with local contractors who match your scope, location, and timeline.
          </p>
          <div style={{display:'flex',flexWrap:'wrap',gap:'12px',marginBottom:'28px'}}>
            <a href="#submit-project" style={{display:'inline-block',padding:'14px 28px',backgroundColor:'#C8732A',color:'#FAF7F2',fontWeight:600,fontSize:'14px',borderRadius:'3px',textDecoration:'none'}}>Post Your Project &rarr;</a>
            <a href="/plan" style={{display:'inline-block',padding:'14px 28px',border:'1px solid rgba(122,155,111,0.45)',color:'rgba(245,239,224,0.8)',fontWeight:500,fontSize:'14px',borderRadius:'3px',textDecoration:'none'}}>Start Planning</a>
          </div>
          <p style={{fontSize:'11px',fontFamily:'monospace',letterSpacing:'0.06em',color:'rgba(245,239,224,0.22)'}}>Licensed &middot; Insured &middot; Vermont-based contractors only</p>
        </div>
