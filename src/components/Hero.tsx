...
const S = {
  ...
  card: {backgroundColor:'rgba(15,26,13,0.7)',border:'1px solid rgba(122,155,111,0.2)',borderRadius:'2px',padding:'20px',backdropFilter:'blur(10px)'},
  ...
  countyTag: {display:'inline-block',padding:'4px 10px',margin:'3px',backgroundColor:'rgba(15,26,13,0.7)',border:'1px solid rgba(122,155,111,0.25)',color:'rgba(245,239,224,0.65)',fontSize:'11px',fontFamily:'monospace',borderRadius:'2px'},
...
export default function Hero() {
  ...
  return (
    <section style={S.section}>
      {/* Vermont Green Mountains — Unsplash photo-1506905925346 */}
      <div style={S.photoBg} />
      <div style={S.overlay} />
      ...
      <div style={S.inner}>
        <div>
          <div style={S.badge}>
            <span style={S.dot} />
            <span style={S.badgeText}>Vermont&apos;s Renovation Network</span>
          </div>
          <h1 ref={headRef} style={S.h1}>
            Match your<br/><em style={S.em}>renovation</em><br/>with the right<br/>Vermont contractor.
          </h1>
          <p style={S.p}>
            Alder Projects connects Vermont homeowners with vetted local contractors
            for kitchens, baths, decks, additions, and more &mdash; across all 14 counties.
          </p>
          <div>
