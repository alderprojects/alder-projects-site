const PT = [
  {
    ...
    img:'https://plus.unsplash.com/premium_photo-1686090447480-9eef06ce4723?auto=format&fit=crop&w=600&q=80',
    tag:'Most Requested',
  },
  {
    t:'Bathroom Renovation',
    d:'Full gut-and-replace or targeted upgrades — tile, vanity, shower, fixtures.',
    img:'https://plus.unsplash.com/premium_photo-1686090446868-92b77789ad08?auto=format&fit=crop&w=600&q=80',
    tag:null,
  },
  {
    t:'Deck & Porch',
    d:'New builds, replacements, screened porches, and seasonal outdoor structures.',
    img:'https://images.unsplash.com/photo-1754597215918-b4b1f113ca77?auto=format&fit=crop&w=600&q=80',
    tag:'Summer Favorite',
  },
  {
    t:'Basement Finishing',
    d:'Convert unfinished space to living area, home office, or rental apartment.',
    img:'https://images.unsplash.com/photo-1646592491741-e79ae5953486?auto=format&fit=crop&w=600&q=80',
    tag:null,
  },
  {
    t:'Room Addition',
  ...
  },
  {
    ...
    img:'https://plus.unsplash.com/premium_photo-1686090449192-4ab1d00cb735?auto=format&fit=crop&w=600&q=80',
    tag:'Seasonal',
  },
  {
    t:'Plumbing & HVAC',
    d:'Heating systems, radiant floor, boiler upgrades, and plumbing repairs.',
    img:'https://plus.unsplash.com/premium_photo-1664298589198-b15ff5382648?auto=format&fit=crop&w=600&q=80',
    tag:null,
  },
  {
    t:'Electrical',
