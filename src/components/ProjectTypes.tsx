    ...
    <section id="project-types" style={{padding:'clamp(56px,8vw,96px) 24px',backgroundColor:'#F5EFE0'}}>
      <div style={{maxWidth:'1152px',margin:'0 auto'}}>
        ...
        <div style={{display:'grid',gridTemplateColumns:'repeat(auto-fill,minmax(260px,1fr))',gap:'20px'}}>
          {PT.map((p) => (
            <div key={p.t} style={{display:'flex',flexDirection:'column',backgroundColor:'white',borderRadius:'4px',overflow:'hidden',border:'1px solid rgba(28,43,26,0.08)',transition:'transform 0.2s,box-shadow 0.2s'}}
