...
import type { SeasonalGuideContent } from '@/content/seasons'

// Shared rendering component for the 5 V6 seasonal guides.
// Each season's page.tsx imports its content record and renders
// <SeasonalGuide content={content} path={...} />.
//
// Voice rules enforced at draft time (per voice-guide.md);
// rendering is structural only.
