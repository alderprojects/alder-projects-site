...
const CATEGORIES = ['New Home Construction','Home Renovation / Remodel','Room Addition / Expansion','Commercial Build-Out','Roofing / Weatherization','Deck / Porch / Outdoor Structure','Plumbing / HVAC','Electrical','Other']
