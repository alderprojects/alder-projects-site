...
// v7.2.14 — Window weatherization vs replacement guide.
// Pilot SEO authority page. CTA into the window weatherization
// Smart Cart for buyers whose frames are intact and whose problem
// is drafts, not glass.

export const WINDOW_FILM_VS_REPLACEMENT_VERMONT_CONTENT: TopicGuideContent = {
  slug: 'window-film-vs-replacement-vermont',
  topicId: 'weatherization',
  metaTitle: 'Window film vs window replacement in Vermont — what to try first',
  metaDescription:
    "Vermont winters expose every weak window. Before $800-$1,500/window replacement, try $80-$220 of film, weatherstripping, and draft control. Here's how to tell which problem you actually have.",
  h1: 'Window film vs. window replacement in Vermont — what to try first.',
  ...
  sections: [
    {
      h2: 'The two problems that look the same in November',
      body: `When a Vermont window is "drafty," the sensation is identical whether the cause is air leaking around the frame or single-pane glass radiating cold. The fix is completely different.
...
**Vermont-specific:** the math runs faster than 90% of US states because Vermont averages 7,500-8,500 heating degree days annually. Air-leak fixes pay back in one winter on most pre-1990 homes. **Trap:** assuming all "drafty" windows have the same problem. A house built in 1965 has a mix — some frames intact and just leaky, some glass genuinely past saving. Diagnose each window separately before quoting replacement on the whole house.`,
    ...
    {
      h2: 'When weatherization is the right answer',
      body: `Weatherization is the right call when the frames are intact and the problem is air movement around the sash, the frame, or the trim.
...
**Trap:** trying to weatherize a window where the frame is rotted or the sash no longer seats properly. Film won't bond to wet wood; weatherstripping doesn't compress against a warped sash. If the frame fails the press-test or the sash doesn't latch, weatherization is the wrong scope.`,
    ...
    {
      h2: 'When replacement is the right answer',
      body: `Replacement is the right call when the window itself is past saving — frames rotted, glass failed beyond film's reach, or the operation is so degraded that weatherization can't seal it.
...
**Vermont-specific:** Efficiency Vermont does not currently rebate window replacement on most residential projects (some custom historic-preservation cases excepted). The $800-$1,500/window math is real out-of-pocket. **Trap:** the contractor who pitches "Energy Star windows pay for themselves" — the payback math doesn't work in Vermont's residential context for utility bills alone.`,
    ...
    {
      h2: 'How to test for air leaks before you buy anything',
      body: `Before spending $80 or $8,000, do the diagnostic. Three minutes per window with a $5 tool.
...
**Vermont-specific:** test on a windy day in November or January. Vermont winds at 15-25 mph drive the pressure differential that makes leaks audible and felt. Calm days hide them.`,
    },
    {
      ...
      body: `The window weatherization Smart Cart is a curated $80-$220 product list for the buyer who has diagnosed the problem as drafts and wants to close them for one winter without replacing windows.
...
- Optional: low-cost interior storm insert for one priority window

**What it skips for you:**
- Custom acrylic interior storm inserts (Indow-style, $400+/window — premium tier when film does 80% of the job)
...
- Single-pane in a long-term primary residence where comfort and resale are real goals — consider replacement or storm windows seriously
...
**Trap:** treating the cart as a permanent solution for a window that's past saving. The cart is a stopgap for one winter. If after running through it you still feel cold radiating off the glass, the issue is the glass, not the air.`,
    ...
    {
      h2: 'Sequencing for a Vermont winter',
      body: `For a typical Vermont homeowner with a leaky pre-1990 house, the right order:
...
**Vermont-specific:** EVT's weatherization rebate (75% standard tier, 90% income-eligible) covers the professional air-sealing scope that windows are usually downstream of. The biggest payback is rim-joist sealing in the basement and attic plate sealing — not window replacement. **Trap:** spending $10,000 on windows when the same money on professional weatherization would save 4x the energy. Sequence your projects; windows are usually last.`,
    ...
    {
      h2: 'When to call a window installer instead',
      body: `If the diagnosis points to replacement, get the right pro. Window installers are a separate trade from general contractors and weatherization specialists.
...
**Trap:** hiring a general contractor for window replacement when the project is just windows. GC markups (15-30%) and scheduling complications usually make the GC the wrong choice for a pure-window project. **What to do:** start at /window-replacement-vermont (or your county's window-replacement page) for vetted Vermont window specialists. The Smart Cart is a stopgap, not a substitute for the right pro.`,
  ...
  faq: [
    {
      question: 'How much does window weatherization actually save vs. replacement?',
      answer:
    ...
    {
      question: "When is window replacement actually worth it in Vermont?",
      answer:
    ...
    {
      question: 'Will the EVT rebate cover window replacement?',
      answer:
    ...
    {
      question: "Should I weatherize windows before getting an energy audit?",
      answer:
    ...
    {
      question: "Does interior shrink film actually work in Vermont winters?",
      answer:
