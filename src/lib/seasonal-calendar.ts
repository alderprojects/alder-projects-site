...
export const SEASONAL_CALENDAR: SeasonalConfig[] = [
  ...
  },
  {
    ...
    primaryCtaLabel: 'Build my Memorial Day cart — $19.99',
    primaryCtaHref: '/smart-cart?topic=outdoor&scope=memorial_day_weekend&utm_source=homepage&utm_medium=hero&utm_campaign=memorial_day_2026',
    secondaryCtaLabel: 'Read Lake Buy/Skip/Wait',
    secondaryCtaHref: '/guides/lake-season-buy-skip-wait',
    chatPrompt: 'Should I buy patio furniture this Memorial Day?',
    featuredScope: 'memorial_day_weekend',
    featuredGuide: { label: 'Memorial Day 2026: Buy/Skip/Wait', href: '/guides/memorial-day-vermont-2026' },
  },
  {
    month: 6,
    eyebrow: 'June',
